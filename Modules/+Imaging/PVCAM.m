...
%         maxROI = [-1 1; -1 1];
    ...
    properties(GetObservable,SetObservable)
        ...
        width =         Prefs.Integer(0, 'unit', 'pix', 'help_text', 'Width that the camera thinks it has.', 'readonly', true);
        height =        Prefs.Integer(0, 'unit', 'pix', 'help_text', 'Height that the camera thinks it has.', 'readonly', true);
        temp =          Prefs.Integer(0, 'unit', 'deg C', 'help_text', 'Temp that the camera thinks it is at.', 'readonly', true);
%         ROI = Prefs.DoubleArray([1,2;3,4], 'allow_nan', false, 'min', 0, 'set', 'testSet');
        
        gain =          Prefs.Double(1, 'min', 1, 'readonly', true); % Add better limits.
        
        binning =       Prefs.Integer(1, 'unit', 'pix', 'min', 1, 'max', 4, 'help_text', 'indexed from 0');   % This is camera-dependent...
        
        exposure =      Prefs.Double(1000, 'unit', 'ms', 'min', 0); % Add better limits.
