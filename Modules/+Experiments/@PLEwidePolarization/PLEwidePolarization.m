...
%         power_flipmount_SN = '37000086';
    ...
    properties
        prefs = {'resLaser','takeSpec','ScanRange','PolarizationAngleRange','LaserPowerTarget','LaserPowerTolerance','Detection_Type','APD_line','APD_dwell','motor_SN','power_motor_SN'};  % String representation of desired prefs
