classdef T1_flur < Experiments.PulseSequenceSweep.PulseSequenceSweep_invisible
    %T1_flur Characterizes T1 by optically repumping then resonantly addressing with a swept time delay
    ...
    methods(Access=private)
        function obj = T1_flur()
            obj.prefs = [obj.prefs,{'exciteLaser','APDline','repumpTime_us','countTime','tauTimes_us'}]; %additional preferences not in superclass
            obj.loadPrefs;
        end
    end
